...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         it('the url in each feed is defined', function() {
         ...
         */
         it('the name in each feed is defined', function() {
            allFeeds.forEach(function(feed) {
    ...
    describe('New Feed Selection', function() {
         ...
         */
         ...
         it('the content should change when a new feed is loaded', function(done) {
